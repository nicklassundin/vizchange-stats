...
module.exports = {
	...
	getByParamsPreCalculated: function (specs, params){
		return axios.get(`${specs.url}/precalculated/${specs.station}/${params.join('/')}?start=${configs.dates.start}&end=${configs.dates.end}baselineStart=${configs.baseline.start}&baselineEnd=${configs.baseline.end}`)
	},
