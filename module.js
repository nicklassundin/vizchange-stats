...
module.exports = {
	...
	getByParamsPreCalculated: function (specs, params){
		return axios.get(`${specs.url}/precalculated/${specs.station}/${params.join('/')}?start=${specs.dates.start}&end=${specs.dates.end}baselineStart=${specs.baseline.start}&baselineEnd=${configs.baseline.end}`)
	},
